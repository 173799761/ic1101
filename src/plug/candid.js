...
// The canister interface description language—often referred to as Candid
// or more generally as the IDL—provides a common language for specifying
// the signature of a canister service.
// Candid provides a unified way for you to interact with canisters that
// are written in different languages or accessed using different tools.
const nnsUi = ({ IDL }) => {
